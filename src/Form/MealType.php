...
class MealType extends AbstractType {
    public function buildForm(FormBuilderInterface $builder, array $options): void {
        $builder
            ...
            ->add("section", ChoiceType::class, ["label" => "Sekce", "choices" => $options["sections"], "choice_value" => "id", "choice_label" => "name"])
            ->add("course", ChoiceType::class, ["label" => "Chod", "choices" => $options["courses"], "choice_value" => "id", "choice_label" => "name"])
        ...
        $builder->get("price")->addModelTransformer(new CallbackTransformer(
            function($price): string { // Transform saved data 
                return str_replace(".", ",", $price);
            },
            function($price): float { // Transform data before processed
