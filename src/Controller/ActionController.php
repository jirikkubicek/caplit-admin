...
class ActionController extends BaseCRMController {
    const BASE_ROUTE = "/actions";
    const LIST_ROUTE_NAME = "actions_list";
    const ADD_ROUTE_NAME = "actions_add";
    const EDIT_ROUTE_NAME = "actions_edit";
    const REMOVE_ROUTE_NAME = "actions_remove";

    public function __construct(ValidatorInterface $Validator, Action $Action) {
        parent::__construct($Validator);

        $this
            ->setEntity(new Actions)
            ->setFormTypeName(ActionType::class)
            ->setService($Action)
            ->addTemplate(self::TEMPLATES_LIST_KEY_NAME, "actions.html.twig", self::LIST_ROUTE_NAME)
            ...
            ->Messages->addMessages([
                [Messages::ACTION_KEY_NAME => "list", Messages::NAME_KEY_NAME => "header", Messages::MESSAGE_KEY_NAME => "Přehled akcí"],
                [Messages::ACTION_KEY_NAME => "add", Messages::NAME_KEY_NAME => "header", Messages::MESSAGE_KEY_NAME => "Přidání akce"],
                [Messages::ACTION_KEY_NAME => "edit", Messages::NAME_KEY_NAME => "header", Messages::MESSAGE_KEY_NAME => "Úprava akce"]
            ]);
    }
